...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2017 at 04:29 AM
...
CREATE TABLE `bayar` (
  ...
  `order_customer_id_customer` int(11) NOT NULL,
  `order_produk_id_produk` int(11) NOT NULL,
  `order_produk_kategori_id_kategori` int(11) NOT NULL,
...
--
-- Table structure for table `input_detail_transaksi`
--

CREATE TABLE `input_detail_transaksi` (
  `kasir_id_kasir` int(11) NOT NULL,
  `order_customer_id_customer` int(11) NOT NULL,
  `order_produk_id_produk` int(11) NOT NULL,
  `order_produk_kategori_id_kategori` int(11) NOT NULL,
  `id_input_detail_transaksi` int(11) NOT NULL,
...
CREATE TABLE `jasa_pengiriman` (
  ...
  `nama_jasa_pengiriman` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `order` (
  ...
  `produk_kategori_id_kategori` int(11) NOT NULL,
  `id_order` int(11) NOT NULL,
  `tgl_order` datetime NOT NULL,
  `jmlh_orderan` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `pengiriman` (
  `jasa_pengiriman_id_jasa_pengiriman` int(11) NOT NULL,
  `order_customer_id_customer` int(11) NOT NULL,
  `order_produk_id_produk` int(11) NOT NULL,
  `order_produk_kategori_id_kategori` int(11) NOT NULL,
...
--
ALTER TABLE `bayar`
  ADD PRIMARY KEY (`customer_id_customer`,`order_customer_id_customer`,`order_produk_id_produk`,`order_produk_kategori_id_kategori`),
  ADD KEY `fk_customer_has_order_order1_idx` (`order_customer_id_customer`,`order_produk_id_produk`,`order_produk_kategori_id_kategori`),
  ADD KEY `fk_customer_has_order_customer1_idx` (`customer_id_customer`);
...
--
-- Indexes for table `input_detail_transaksi`
--
ALTER TABLE `input_detail_transaksi`
  ADD PRIMARY KEY (`kasir_id_kasir`,`order_customer_id_customer`,`order_produk_id_produk`,`order_produk_kategori_id_kategori`,`id_input_detail_transaksi`),
  ADD KEY `fk_kasir_has_order_order1_idx` (`order_customer_id_customer`,`order_produk_id_produk`,`order_produk_kategori_id_kategori`),
  ADD KEY `fk_kasir_has_order_kasir1_idx` (`kasir_id_kasir`);
...
--
ALTER TABLE `login`
  ADD PRIMARY KEY (`idlogin`,`customer_id_customer`),
  ADD KEY `fk_login_customer_idx` (`customer_id_customer`);

--
-- Indexes for table `order`
--
ALTER TABLE `order`
  ADD PRIMARY KEY (`customer_id_customer`,`produk_id_produk`,`produk_kategori_id_kategori`),
  ADD KEY `fk_customer_has_produk_produk1_idx` (`produk_id_produk`,`produk_kategori_id_kategori`),
  ADD KEY `fk_customer_has_produk_customer1_idx` (`customer_id_customer`);

--
-- Indexes for table `pengiriman`
--
ALTER TABLE `pengiriman`
  ADD PRIMARY KEY (`jasa_pengiriman_id_jasa_pengiriman`,`order_customer_id_customer`,`order_produk_id_produk`,`order_produk_kategori_id_kategori`),
  ADD KEY `fk_jasa_pengiriman_has_order_order1_idx` (`order_customer_id_customer`,`order_produk_id_produk`,`order_produk_kategori_id_kategori`),
  ADD KEY `fk_jasa_pengiriman_has_order_jasa_pengiriman1_idx` (`jasa_pengiriman_id_jasa_pengiriman`);

--
-- Indexes for table `produk`
--
ALTER TABLE `produk`
  ADD PRIMARY KEY (`id_produk`,`kategori_id_kategori`),
...
--
ALTER TABLE `bayar`
  ADD CONSTRAINT `fk_customer_has_order_customer1` FOREIGN KEY (`customer_id_customer`) REFERENCES `customer` (`id_customer`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_customer_has_order_order1` FOREIGN KEY (`order_customer_id_customer`,`order_produk_id_produk`,`order_produk_kategori_id_kategori`) REFERENCES `order` (`customer_id_customer`, `produk_id_produk`, `produk_kategori_id_kategori`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `input_detail_transaksi`
--
ALTER TABLE `input_detail_transaksi`
  ADD CONSTRAINT `fk_kasir_has_order_kasir1` FOREIGN KEY (`kasir_id_kasir`) REFERENCES `kasir` (`id_kasir`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_kasir_has_order_order1` FOREIGN KEY (`order_customer_id_customer`,`order_produk_id_produk`,`order_produk_kategori_id_kategori`) REFERENCES `order` (`customer_id_customer`, `produk_id_produk`, `produk_kategori_id_kategori`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `kecamatan`
  ADD CONSTRAINT `districts_regency_id_foreign` FOREIGN KEY (`regency_id`) REFERENCES `kabupaten` (`id`);

--
-- Constraints for table `login`
--
ALTER TABLE `login`
  ADD CONSTRAINT `fk_login_customer` FOREIGN KEY (`customer_id_customer`) REFERENCES `customer` (`id_customer`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `order`
--
ALTER TABLE `order`
  ADD CONSTRAINT `fk_customer_has_produk_customer1` FOREIGN KEY (`customer_id_customer`) REFERENCES `customer` (`id_customer`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_customer_has_produk_produk1` FOREIGN KEY (`produk_id_produk`,`produk_kategori_id_kategori`) REFERENCES `produk` (`id_produk`, `kategori_id_kategori`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `pengiriman`
--
ALTER TABLE `pengiriman`
  ADD CONSTRAINT `fk_jasa_pengiriman_has_order_jasa_pengiriman1` FOREIGN KEY (`jasa_pengiriman_id_jasa_pengiriman`) REFERENCES `jasa_pengiriman` (`id_jasa_pengiriman`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_jasa_pengiriman_has_order_order1` FOREIGN KEY (`order_customer_id_customer`,`order_produk_id_produk`,`order_produk_kategori_id_kategori`) REFERENCES `order` (`customer_id_customer`, `produk_id_produk`, `produk_kategori_id_kategori`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `produk`
--
ALTER TABLE `produk`
  ADD CONSTRAINT `fk_produk_kategori1` FOREIGN KEY (`kategori_id_kategori`) REFERENCES `kategori` (`id_kategori`) ON DELETE NO ACTION ON UPDATE NO ACTION;
