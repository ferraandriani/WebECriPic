	...
	<section id="slider"><!--slider-->
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>E</span>-CriPIC</h1>
									<h2>Ini Template web</h2>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-7" >
					<div class="chose_area text-center" style="background-color:	#343432;">
						<div >
				 		<img class="center-block img-responsive " src="<?php echo base_url() ?>assets/images/home/cart.png" alt="" style="	background:#FE980F; border-radius: 40px;">
				 		</div>
					<!--	<div> -->

						<a href="login.html" type="button" class="btn btn-default  update" >log in</a>
						<a href="sign up.html" type="button" class="btn btn-default  update">sign up</a>
						<!--	</div> -->
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Pisang</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Sigkong</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Kentang</a></h4>
								</div>
							</div>
